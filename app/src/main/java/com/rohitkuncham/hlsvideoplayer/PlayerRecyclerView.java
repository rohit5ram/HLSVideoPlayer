...
public class PlayerRecyclerView extends RecyclerView {
    ...
    private static final String TAG = "PlayerRecyclerView";
    ...
    public PlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        TrackSelector trackSelector =
                new DefaultTrackSelector(context, adaptiveTrackSelectionFactory);
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultHttpDataSource.Factory()
                ...
                .setUserAgent(Util.getUserAgent(context, "VideoPlayerRecyclerView"));
        String mediaUrl = mediaObjects.get(targetPosition % mediaObjects.size()).getMedia_url();
        if (mediaUrl != null) {
